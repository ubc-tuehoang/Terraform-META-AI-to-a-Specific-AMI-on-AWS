...
_NOTE: To deployment using Terraform with a standard AWS EC2 instance (not to a specific AMI), t2.2xlarge, running Ubuntu.  <a href="[https://example.com](https://github.com/ubc-tuehoang/Terraform-META-AI-Llama3-with-AWS-EC2-Infrastructure)" target="_blank">Click here</a>._
